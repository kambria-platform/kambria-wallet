...
const MACHINE = {
  ...
  SelectWallet: {
    ...
    nextState: [
      { step: 'InputAsset', pattern: { type: 'softwallet', wallet: 'binance-sdk' } },
...
const DEFAULT = {
  ...
  wallet: null, // binance-sdk, ledger, trust-wallet
  model: null, // mnemonic, keystore, private-key, ledger-nano-s, trust-wallet
  dpath: null,
  index: null,
  asset: null
}
