...
const STATUS = {
  INIT: 'Please use Trust Wallet application on your phone to scan and establish the connection!',
...
class TrustAsset extends Component {
  ...
  establishTheConnection = () => {
    ...
    this.trust = new Trust(window.kambriaWallet.networkId.binance, options);
