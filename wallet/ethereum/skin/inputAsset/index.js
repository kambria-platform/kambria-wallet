    ...
    return (
      <Modal visible={true} className={cx("fade", "wallet-modal", "software-wallet")} dialogClassName={cx("modal-dialog-centered")}>
        <div className={cx("modal-body")}>
          ...
          <span className={cx("title", "d-block", "text-center", "mt-4")}>Software Wallet</span>
          <span
          ...
          <p className={cx("subtitle", "d-block", "text-center", "mb-4", "fail")}>This is not a recommended way to access your wallet.</p>
          {this.menu()}
